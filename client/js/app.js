var app = new Vue({
    ...
    methods: {
        ...
        encode: function(bits,numberOfDataBits){
            if(numberOfDataBits == 4)
			{
				...
				var C0=this.parity(parseInt(bits[0].data)+parseInt(bits[1].data)+parseInt(bits[2].data)+parseInt(bits[3].data)); // se calculeaza bitul de paritate
				...
				var C0=this.parity(parseInt(bits[0].data)+parseInt(bits[1].data)+parseInt(bits[2].data)+parseInt(bits[3].data)+parseInt(bits[4].data)+parseInt(bits[5].data)+parseInt(bits[6].data)+parseInt(bits[7].data)); // se calculeaza bitul de paritate
